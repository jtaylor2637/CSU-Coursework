...
public class TreeNode<T extends Comparable>{
    ...
    public String parentPrint()
    {
        if(getParent()== null)
        {
            return "Node: " + getContents() + " Parent Node: none";
        }
        else
        {
            return "Node: " + getContents() + " Parent Node: " + getParent().getContents();
        }        
    }

    public String leftChildPrint()
    {
        if(getLeftChild()== null)
        {
            return "Node: " + getContents() + " Left Child: none";
        }
        else
        {
            return "Node: " + getContents() + " Left Child: " + getLeftChild().getContents();
        }        
    }        

    public String rightChildPrint()
    {
        if(getRightChild()==null)
        {
            return "Node: " + getContents() + " Right Child: none";
        }
        else
        {
            return "Node: " + getContents() + " Right Child: " + getRightChild().getContents();
        }
    }
}
